...
The table contains Client, Deal, Deal Type, Sales Executive, Deal Value (USD), and Commercially Approved On. Rows are ordered by Deal Value from highest to lowest.
...
The PP FM TEST checkpoint is initially seeded to `2026-09-01T00:00:00Z`, which currently provides five approved records for the first delivery test. Each environment has independent state.
